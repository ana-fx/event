        ...
        <div class="relative z-10 w-full max-w-6xl px-6 flex flex-col md:flex-row items-center justify-between gap-16">
            ...
            <div class="flex-1 text-center md:text-left space-y-8 order-2 md:order-1">
                ...
                <div class="pt-4 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <button disabled
                        class="px-8 py-4 bg-gray-200 text-gray-500 font-bold rounded-xl cursor-not-allowed flex items-center justify-center gap-2 group">
                        <span>Check Back Soon</span>
                    </button>
                    <!-- Optional: Social Links if available, else just a static message -->
                </div>
            </div>
            ...
            <div class="flex-1 relative flex items-center justify-center order-1 md:order-2">
                ...
                <h1
                    ...
                    <span
                        class="relative z-20 bg-clip-text text-transparent bg-gradient-to-br from-dark to-primary opacity-90">503</span>
                </h1>
            </div>
