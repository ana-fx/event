...
func main() {
	...
	// 4. Create Admin User
	log.Println("Creating admin user (admin@admin.com)...")
	...
	// 5. Create Exactly ONE High-Quality Event
	log.Println("Creating single high-quality event...")
	...
	// 6. Create Tickets
	log.Println("Creating tickets for the event...")
	...
	// 7. Create Banner
	log.Println("Creating homepage banner for the event...")
	...
	log.Println("Database reset and initial seeding completed successfully!")
}
