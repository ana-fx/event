...
export default function SettingsContent() {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        } catch (e) { toast.error("Failed to save settings"); } // eslint-disable-line @typescript-eslint/no-unused-vars
        ...
        <div className="max-w-2xl">
            ...
            <form onSubmit={handleSave} className="bg-(--card) p-6 rounded-xl border border-(--card-border) shadow-sm space-y-6">
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input type="text" className="w-full px-4 py-2.5 rounded-lg border border-(--card-border) focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all bg-(--background) text-(--foreground)"
                        ...
                        <div>
                            ...
                            <input type="email" className="w-full px-4 py-2.5 rounded-lg border border-(--card-border) focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all bg-(--background) text-(--foreground)"
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input type="url" className="w-full px-4 py-2.5 rounded-lg border border-(--card-border) focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all bg-(--background) text-(--foreground)"
                ...
                <div className="pt-4 flex justify-end">
                    <button type="submit" disabled={saving} className="px-6 py-2.5 bg-primary text-white font-bold rounded-lg hover:bg-primary transition-colors shadow-sm shadow-primary/20 disabled:opacity-70 flex items-center justify-center">
