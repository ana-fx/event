    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white/95 backdrop-blur-xl border-t border-gray-100 p-4 pb-8 flex items-center justify-between shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
            ...
            <button 
                ...
                className="px-8 py-4 bg-brand-dark text-white text-[10px] font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-brand-dark/20 active:scale-95 transition-all font-heading"
            >
                Book Now
            </button>
        </div>
